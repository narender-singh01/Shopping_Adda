...
const Login = () => {
  ...
  const handleError = () => {
    if (!input.email||!input.email.trim() ||!input.password||!input.password.trim()) {
    ...
    <ScrollView style={styles.container}>
      ...
      <View>
        ...
        <TextInputComponent
          ...
          name="email"
          value={input.email || ''}
          onChangeText={value => {handleChange(`email`, value);setError(input.email)}}
        />
        ...
        <TextInputComponent
          ...
          onChangeText={value => {handleChange(`password`, value);setError(input.password)}}
          type={'password'}
        />
